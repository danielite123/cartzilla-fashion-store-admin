...
import Table, { TableHead, TableBody, TableRow, TableCell, TableHeadItem } from './table';
...
const sampleData = [
  ...
  { id: 5, name: 'Charlie Wilson', email: 'charlie@example.com', status: 'Inactive', role: 'Editor' },
  ...
  { id: 10, name: 'Helen Rodriguez', email: 'helen@example.com', status: 'Active', role: 'Admin' },
  { id: 11, name: 'Ian Thompson', email: 'ian@example.com', status: 'Inactive', role: 'Editor' },
  { id: 12, name: 'Julia White', email: 'julia@example.com', status: 'Active', role: 'User' },
];
...
export default function TableExample() {
  ...
  const renderRowCard = (item: any, index: number) => (
